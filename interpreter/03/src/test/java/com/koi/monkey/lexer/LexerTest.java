...
//                !-/*5;5 < 10 > 5;
    ...
    public void testNextToken5() {
        String input = "let five = 5;let ten = 10;let add = fn(x, y) {  x + y;};let result = add(five, ten);!-/*5;5 < 10 > 5;if (5 < 10) {    return true;} else {    return false;}10 == 10;10 != 9;\"foobar\"\"foo bar\"";
        String[][] tests = {
                {TokenType.LET,"let"},
                {TokenType.IDENT,"five"},
                {TokenType.ASSIGN,"="},
