...
public class Parser {
    ...
    private static final int INDEX = 6; // array[index]
    ...
    static {
        ...
        infixOperators.add(TokenType.LBRACKET);
    }
    ...
    private Expression parseArrayLiteral() {
        ...
        array.token = this.curToken;
        array.elements = parseExpressionList(TokenType.RBRACKET);
        return array;
    }

    private List<Expression> parseExpressionList(String endTokenType) {
